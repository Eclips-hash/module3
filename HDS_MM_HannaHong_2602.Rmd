...
```{r q2-fig2a-oncoplot-clean, fig.width=12, fig.height=9, results='hide'}
# ============================================
...
The most frequently mutated genes among Luminal-enriched IntClust groups (2, 3, 6, 7, 8, 9) were TP53 (`r tp53_overall_pct`%) and PIK3CA (`r pik3ca_overall_pct`%) (Figure 2E), representing key oncogenic pathways: TP53 (tumour suppressor, genomic instability) and PIK3CA (PI3K pathway activation, cell survival). Note that whole-cohort frequencies differ from these Luminal-group figures (Figure 2A).

### Mutation Burden and Subtype-Specific Patterns

Mutation burden differed significantly by PAM50 subtype (Kruskal-Wallis p < 0.001, Figure 2C), with Basal-like tumours showing highest burden, consistent with genomic instability characteristic of aggressive disease. Among Luminal-enriched IntClust groups, differences were less pronounced (Figure 2D), suggesting mutation burden alone does not fully explain IntClust-based risk stratification.
...
These findings align with the original METABRIC publication, which identified IntClust 2 as a high-risk subgroup (HR = 3.62, 95% CI: 1.91–6.88) (Curtis et al. 2012), and the validation study by Ali et al. (2014). The molecular drivers—CCND1 and FGFR1 amplifications—have therapeutic relevance through CDK4/6 inhibitors (Turner et al. 2015; Finn et al. 2016) and FGFR inhibitors (Formisano et al. 2019).
